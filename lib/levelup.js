...
var getOptions = function (options, globalOptions) {
  ...
  , createLevelUP = function (location, options, callback) {
      ...
      function LevelUP (location, options) {
        ...
        externs.constructor(
            this
          , [ extend(extend({}, defaultOptions), options) ]
          , function (options) {
        ...
        if ((keyEncoding != 'utf8' && keyEncoding != 'binary')
          ...
          arr = arr_.map(function (e) {
            if (e.type !== undefined && e.key !== undefined) {
              var o = {
                  type: e.type
                , key: externs.inKey(toSlice[keyEncoding](e.key))
              }

              if (e.value !== undefined)
                o.value = externs.inValue(toSlice[valueEncoding](e.value))
