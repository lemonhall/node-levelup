...
function ReadStream (options, db, externs, iteratorFactory) {
  ...
  if (typeof this._options.start != 'undefined')
    this._options.start = externs.inKey(toSlice[this._keyEncoding](this._options.start))
  if (typeof this._options.end != 'undefined')
    this._options.end = externs.inKey(toSlice[this._keyEncoding](this._options.end))
